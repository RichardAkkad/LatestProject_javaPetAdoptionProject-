...
public class PetService {
    ...
    public String getPagePetService(Model model) {
    ...
    public String submitPagePetService(Dog dog) {
    ...
    public String IdResultsPetService(Long id, Model model) {
        ...
        public String filterResultsPetService(int minAge, int maxAge, String breed, String colour, String sex, Model model) {
        ...
        public String deletePetService ( long id){
